...
func (i Item) Description() string {
	if i.Discount != 0 {
		return fmt.Sprintf("%s - %2.f TL (%2.f%% İndirimli %2.f TL)", i.Name, i.Price, i.Discount, i.Price-i.Discount)
	}
...
func main() {
	item1 := Item{Name: "Elma", Price: 10, Discount: 2}
	item2 := Item{Name: "Armut", Price: 20, Discount: 3}
